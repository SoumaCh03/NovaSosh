...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'COMMENT', 'FOLLOW', 'FOLLOW_REQUEST', 'MENTION', 'MESSAGE', 'SHARE', 'SYSTEM');
...
-- CreateEnum
CREATE TYPE "ModerationActionType" AS ENUM ('CONTENT_REMOVED', 'USER_WARNED', 'USER_SUSPENDED', 'USER_BANNED', 'NO_ACTION');
...
-- AddForeignKey
ALTER TABLE "PasswordHistoryEntry" ADD CONSTRAINT "PasswordHistoryEntry_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
